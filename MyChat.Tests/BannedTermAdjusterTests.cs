...
namespace MindLink.Recruitment.MyChat.Tests
{
    ...
    public class BannedTermAdjusterTests
    {
        ...
        {
            IAdjuster ad = new BannedTermRedactor("banned");
        ...
        {
            IAdjuster ad = new BannedTermRedactor("nothing");
        ...
        {
            IAdjuster ad = new BannedTermRedactor("with");
        ...
        {
            IAdjuster ad = new BannedTermRedactor("Casing");
        ...
        {
            IAdjuster ad = new BannedTermRedactor("pie");
        ...
        public void chain_of_redacted_words_adjusts_message_properly()
        {
            ...
            IAdjuster bt = new BannedTermRedactor("I'm");
            IAdjuster nextBt = new BannedTermRedactor("david");
        ...
        public void single_letter_redacted_item_does_not_catch_apostrophe_items()
        {
            ...
            IAdjuster bt = new BannedTermRedactor("I");
        ...
        public void word_with_non_terminal_punctuation_is_not_redacted()
        {
            ...
            IAdjuster bt = new BannedTermRedactor("there");
            Assert.That(bt.Adjust(m).content, Is.EqualTo("there's got to be more to eat"));
        }
        
        [Test]
        public void filterers_pass_but_banned_term_not_in_message()
        {
            IMessage m = new Message(new[] {"1234", "david", "there's got to be more to eat!"});
            IAdjuster bt = new BannedTermRedactor("eat");
            Assert.That(bt.Adjust(m).content, Is.EqualTo("there's got to be more to *redacted*!"));
        }
    }
}