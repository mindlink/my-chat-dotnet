...
namespace MindLink.Recruitment.MyChat.Sates
{
    class DispalyHelp : State
    {
        ...
        public override State Run()
        {
            ...
            // help screen
            Console.WriteLine(" How to use conversation command-line utility :");
            Console.WriteLine("----------------------------------------------------------");
            Console.WriteLine("/i       Defines the input files from where a conversation will be loaded e.g: /i inputfile.txt");
            Console.WriteLine("/o       Defines the output files where the current conversation will be exported in json format e.g: /o outputfile.json");
            ...
            Console.WriteLine("/b       Hide specific words in the messages content (replace with *redacted*) e.g: /b word1 word2 word3");
            Console.WriteLine("/ct      Hide credit cart and phone like numbers in messages content  e.g: /ct");
            ...
            Console.WriteLine("/?       Display help screen e.g: /?");
            Console.WriteLine("----------------------------------------------------------");
            return null;
        }
